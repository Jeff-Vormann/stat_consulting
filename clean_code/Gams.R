...
#  Konfigurationsdatei laden, um weitere Parameter (wie nbStates, dataset_name, preprocessing) zu verwenden
...
if (file.exists(rds_name)) {
  ...
  beta0= c(-1.9278670,0,0,0,0, -3.6459514,0,0,0,0,  0.3271551,0,0,0,0, -0.43847077,0,0,0,0, -3.78406370,0,0,0,0, -2.791597782,0,0,0,0)
  ...
  hmm_model <- momentuHMM::fitHMM(
    ...
    beta0 <- matrix(beta0, nrow = 5, ncol = 6),
