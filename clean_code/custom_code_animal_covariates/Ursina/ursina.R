...
original_evation <- hmm_data$evation * evation_scale_param + evation_center_param
original_ToD    <- hmm_data$ToD    * ToD_scale_param    + ToD_center_param
print(original_ToD)
...
if (file.exists(rds_name)) {
  ...
  beta0= c(-3.5576915,0,0,0,0, -2.9885748,0,0,0,0)
